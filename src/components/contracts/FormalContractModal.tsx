          ...
          >
            ...
            >
              <div
                ...
                className="w-[794px] bg-white text-black p-[50px] shadow-2xl relative space-y-[40px]"
                style={{ fontFamily: "'Times New Roman', Times, serif" }}
              >
                
                {/* PAGE 1 */}
                <div className="page-section flex flex-col justify-between min-h-[1020px]">
                  <div>
                    {/* Header */}
                    ...
                    <h2 className="text-center font-black text-xs uppercase mb-6 tracking-wide">
                    ...
                    <div className="space-y-4 text-[10px] leading-relaxed text-justify">
                      ...
                      <div className="pl-4 space-y-2">
                        {contract.proposal?.equipment_items?.map((item, idx) => (
                          <div key={item.id} className="border border-neutral-300 p-2 rounded">
                  ...
                  {/* Page Footer */}
                  <div className="border-t border-neutral-300 pt-2 text-center text-[8px] text-neutral-500 font-bold uppercase tracking-wider">
                ...
                <div className="page-section flex flex-col justify-between min-h-[1020px]">
                  <div className="space-y-4 text-[10px] leading-relaxed text-justify">
                    ...
                    <h3 className="font-bold uppercase border-b border-neutral-200 pb-1 mt-4">CLÁUSULA PRIMEIRA - OBJETO</h3>
                    <p>
                    ...
                    <h3 className="font-bold uppercase border-b border-neutral-200 pb-1 mt-4">CLÁUSULA SEGUNDA - VALOR DO OBJETO</h3>
                    <p>
                    ...
                    <h3 className="font-bold uppercase border-b border-neutral-200 pb-1 mt-4">CLÁUSULA TERCEIRA - PREÇO, PRAZO E FORMA DE PAGAMENTO</h3>
                    <p>
                ...
                <div className="page-section flex flex-col justify-between min-h-[1020px]">
                  <div className="space-y-4 text-[10px] leading-relaxed text-justify">
                    <p>
                      3.5. Ao final do período estabelecido no item 3.2, este contrato se renovará a cada período de 30 (trinta) dias com preços ora acertados, sem correção monetária ou reajustes, independente de inflação ou índices de reajustes praticados pelo mercado, podendo quaisquer das partes se manifestar pela não renovação em face de eventual desinteresse na continuação da locação, devendo a outra parte ser notificada com antecedência mínima de 15 (quinze) dias ao término do contrato.
                    </p>
                    <p>
                    ...
                    {/* Schedule Table */}
                    <div className="my-4 border border-neutral-300 rounded overflow-hidden">
                      <table className="w-full text-left text-[9px]">
                        <thead className="bg-neutral-100 border-b border-neutral-300">
                          <tr>
                            <th className="p-2">Parcela</th>
                            <th className="p-2">Detalhamento Financeiro</th>
                            <th className="p-2 text-right">Data de Vencimento</th>
                          </tr>
                        </thead>
                        <tbody className="divide-y divide-neutral-200">
                          {installments.map((inst) => (
                            <tr key={inst.num}>
                              <td className="p-2 font-bold">{inst.num}ª parcela</td>
                              <td className="p-2">{inst.label}{inst.extra}</td>
                              <td className="p-2 text-right font-bold">{inst.date}</td>
                            </tr>
                          ))}
                        </tbody>
                      </table>
                    ...
                    <h3 className="font-bold uppercase border-b border-neutral-200 pb-1 mt-4">CLÁUSULA QUARTA - REAJUSTE</h3>
                    <p>
                ...
                <div className="page-section flex flex-col justify-between min-h-[1020px]">
                  <div className="space-y-4 text-[10px] leading-relaxed text-justify">
                    <h3 className="font-bold uppercase border-b border-neutral-200 pb-1 mt-4">CLÁUSULA QUINTA - MANUTENÇÃO E CONSERVAÇÃO DO BEM</h3>
                    <p>
                    ...
                    <h3 className="font-bold uppercase border-b border-neutral-200 pb-1 mt-4">CLÁUSULA SEXTA - FRETE E MONTAGEM</h3>
                    <p>
                ...
                <div className="page-section flex flex-col justify-between min-h-[1020px]">
                  <div className="space-y-4 text-[10px] leading-relaxed text-justify">
                    <h3 className="font-bold uppercase border-b border-neutral-200 pb-1 mt-4">CLÁUSULA SÉTIMA - RESPONSABILIDADE DO LOCATÁRIO</h3>
                    <p>
                      1) Autorizar a entrada dos funcionários da Contratada no canteiro. A não autorização da entrada do pessoal e/ou equipamentos no local de instalação da obra poderá ensejar a cobrança da hora parada e a postergação dos serviços para data futura;
                    </p>
                    <p>
                ...
                <div className="page-section flex flex-col justify-between min-h-[1020px]">
                  <div className="space-y-4 text-[10px] leading-relaxed text-justify">
                    ...
                    <h3 className="font-bold uppercase border-b border-neutral-200 pb-1 mt-4">CLÁUSULA OITAVA - RESPONSABILIDADE DA LOCADORA</h3>
                    <p>
                    ...
                    <h3 className="font-bold uppercase border-b border-neutral-200 pb-1 mt-4">CLÁUSULA NONA - INADIMPLÊNCIA</h3>
                    <p>
                    ...
                    <h3 className="font-bold uppercase border-b border-neutral-200 pb-1 mt-4">CLÁUSULA DÉCIMA - OBSERVAÇÕES</h3>
                    <p>
                    ...
                    <h3 className="font-bold uppercase border-b border-neutral-200 pb-1 mt-4">CLÁUSULA DÉCIMA PRIMEIRA - QUANTO AO DIREITO DE PROPRIEDADE</h3>
                    <p>
                ...
                <div className="page-section flex flex-col justify-between min-h-[1020px]">
                  <div className="space-y-4 text-[10px] leading-relaxed text-justify">
                    ...
                    <h3 className="font-bold uppercase border-b border-neutral-200 pb-1 mt-4">CLÁUSULA DÉCIMA SEGUNDA - FORO</h3>
                    <p>
                    ...
                    <div className="grid grid-cols-2 gap-8 pt-8 text-[9px]">
                      <div className="space-y-6">
                        <div className="border-t border-neutral-800 pt-2 text-center font-bold">
